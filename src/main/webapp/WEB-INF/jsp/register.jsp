		...
		<div id="login-wrapper" class="png_bg">
			...
			<div id="login-content">
				<form:form method="post" commandName="newuser">					
					...
					<p>
						<label>Email</label>
						<form:input path="email" class="text-input" type="email" />
					</p>
					<br style="clear: both;" />
					<p>
						<label>Password</label>
						<form:password path="password" class="text-input" />
					</p>
					<br style="clear: both;" />
					<p>
						<label>Confirm</label>
						<form:password path="confirmPassword" class="text-input" />
					</p>
					<br style="clear: both;" />
					<p>
